...
var css_248z = ".openModal{background-color:rgba(27,27,27,.1);height:100vh;left:0;position:fixed;top:0;width:100%;z-index:2}.headerModal{background:linear-gradient(rgba(0,0,0,.8),#fff);border-radius:20px 5px 0 0;font-size:24px;height:7vh;top:0;width:100%}#closeModal,.headerModal{align-items:center;color:#fff;display:flex;justify-content:center;position:absolute}#closeModal{background-color:#fff;border:none;border-radius:50%;cursor:pointer;height:30px;padding-bottom:3px;right:-15px;top:-15px;transform:scale(.7);transition:transform .2s;width:30px}#closeModal:after{transform:rotate(45deg)}#closeModal:after,#closeModal:before{background-color:#000;content:\"\";display:block;height:1px;position:absolute;width:12px;z-index:4}#closeModal:before{transform:rotate(-45deg)}.modalContainer{align-items:center;background-color:#fff;border-radius:20px 5px 20px 5px;display:flex;flex-direction:column;font-size:48px;height:30vh;justify-content:center;left:50%;position:fixed;position:relative;top:50%;transform:translate(-50%,-50%);width:50vw}#closeModal:hover{border-radius:30% 10%;box-shadow:2px 1px 1px #383838;padding-bottom:5px;transform:scale(1.02)}.footerModal{align-items:center;background:linear-gradient(#fff,rgba(0,0,0,.8));border-radius:0 0 20px 5px;bottom:0;color:#fff;display:flex;font-size:24px;height:6vh;justify-content:center;position:absolute;width:100%}.closeModal{display:none}";
